...
TEAMS: list[Team] = [
    ...
    Team("Senegal", "SEN", "CAF", 14, 1688.99),
    Team("Mexico", "MEX", "CONCACAF", 15, 1681.03),
    ...
    Team("Qatar", "QAT", "AFC", 55, 1454.96),
    Team("Iraq", "IRQ", "AFC", 57, 1447.14),
    Team("South Africa", "RSA", "CAF", 60, 1429.73),
    Team("Saudi Arabia", "KSA", "AFC", 61, 1421.43),
    Team("Jordan", "JOR", "AFC", 63, 1391.45),
    Team("Bosnia and Herzegovina", "BIH", "UEFA", 65, 1385.84),
